 ...
 * K_WORK_RUNNING, K_WORK_CANCELING, and K_WORK_SYNCED.
 */
 ...
 * K_WORK_CANCELING, and K_WORK_SYNCED.  A zero return value indicates the
 ...
 */
	...
	K_WORK_MASK = BIT(K_WORK_DELAYED_BIT) | BIT(K_WORK_QUEUED_BIT)
		| BIT(K_WORK_RUNNING_BIT) | BIT(K_WORK_CANCELING_BIT) | BIT(K_WORK_SYNCED_BIT),
 ...
 */
	...
	/** @brief Flag indicating a synced work item that is scheduled for
	 * submission to a queue.
	 *
	 * Accessed via k_work_busy_get().  May co-occur with other flags.
	 */
	K_WORK_SYNCED = BIT(K_WORK_SYNCED_BIT),
};
